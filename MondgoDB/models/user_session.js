 ...
 *
 * To clarify, a user_session represents a user's particular session while he is logged
 * in and using the app, while a user can refer to anyone who has registered for a VERN account.
 */

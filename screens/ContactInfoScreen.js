    ...
    render() {
        return(
            <View style={styles.container}>
                ...
                <Text style={styles.infotitle}>Sample Phone Number</Text>

                <Text style={styles.infodata}>Email Address</Text>
                <Text style={styles.infotitle}>Sample Email</Text>
                <Text style={styles.infodata}>Instagram</Text>
                <Text style={styles.infotitle}>Sample Instagram</Text>
                <Text style={styles.infodata}>Snapchat</Text>
                <Text style={styles.infotitle}>Sample Snapchat</Text>
                <Text style={styles.infodata}>Twitter</Text>
                <Text style={styles.infotitle}>Sample Twitter</Text>

                <View>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("EditContactInfoScreen")}>
                        <Text style={{margin: 50}}>Edit Contact Information</Text>
                    </TouchableOpacity>
                </View>
